...
class cFileManager {
	...
	std::string _model_File = "models/models_GRAPHICS_MIDTERM";
	std::string _lights_File = "lights/lights_GRAPHICS_MIDTERM";
	std::string _mesh_File = "models/meshes";


	std::string _shaders_File = "shaders/shaders";
	std::string _complexObj_File = "complex/complex_GRAPHICS_MIDTERM";
