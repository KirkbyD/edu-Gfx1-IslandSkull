...
iGameObject* cThirdPersonCamera::GetLookAtTarget()
{
...
void cThirdPersonCamera::SetTarget(iGameObject* newLookAtTarget)
{
...
void cThirdPersonCamera::Move() {
	...
	this->eye += this->front * -50.0f * followDistance;
	this->eye += this->up * 10.0f * followDistance;
